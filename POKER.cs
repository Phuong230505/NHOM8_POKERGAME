...
@"╚═╝░░░░░░╚════╝░╚═╝░░╚═╝╚══════╝╚═╝░░╚═╝  ╚═╝░░╚═╝╚═╝╚═╝░░╚══╝░╚═════╝░╚═════╝░",
            ...
            public static void MusicOpening()
            {
                ...
                var assembly = Assembly.GetExecutingAssembly();
                Stream soundStream = assembly.GetManifestResourceStream("PROJECT_POKERGAME_N8.Wallpaper(chosic-Trimmed by FlexClip (1) (1).wav");
    ...
    Console.SetCursorPosition((84) / 2 - 5, 28 / 2);
        ...
        public class Program
        {
            public static void Main()
            {
                ...
                var assembly = Assembly.GetExecutingAssembly();
                Stream soundStream = assembly.GetManifestResourceStream("PROJECT_POKERGAME_N8.mix-3m41s-audio-joinercom_0vmZcQv6 (1) (1).wav");
